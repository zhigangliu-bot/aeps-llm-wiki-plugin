...
- 2026-09-17 (M2A / task 09-17-fix-m2a-template-sources):
  ...
  - N4 分治:sources 为 synthesis 必填对象数组(每条含 resource),gen-page 按 --sources 渲染。
-->
...
# OKF §5.1 sources(综合引用的所有相关 wiki 页;对象数组,每条含 resource,
# gen-page 按 --sources 渲染;下方示例块渲染时整体重写)
sources:
