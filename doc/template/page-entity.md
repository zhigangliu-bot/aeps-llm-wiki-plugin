...
- 2026-09-17 (M2A / task 09-17-fix-m2a-template-sources):
  - N4 分治:entity.* 页禁止 sources 字段(物理定位由 source 页顶层 resource 承载),
...
步骤 11 填正文时, 请把你写的实质 H2 节 (## 个人背景 / ## 适用范围 等)
放在 ## 关联导引 之前。
PR-A (#19): 模板章节顺序已与 page-source.md 对齐 —— 自由正文在前,
## 关联导引 / ## 来源资料 / ## 维护说明 在后。
-->
---
# OKF v0.2 §4.1 必填字段
...
# OKF §5.4 / §5.5 lifecycle(可选;stale_after 由 gen-page 自动推导 generated.at + 1 年)
status: stable
