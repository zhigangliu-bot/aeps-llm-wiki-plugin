...
| 2026-09-10 | zhigangliu-bot | v0.6.8:3 处 `generated.by` 示例的 producer 版本号字串同步升级为 0.6.8(修复 issue #18 伴随的版本基线刷新);无字段语义变化。 |
| 2026-09-10 | zhigangliu-bot | v0.6.8 (PR-A):§4.5.2 `stale_after` 明确**基准时间**为 `generated.at`(权威);`updated` 仅展示维护时间,不参与过期判断;TTL 默认值表格化(`concept.standard` +5y,其他 +1y);新增 `--stale-after-base <generated|updated>` 开关文档化(修复 issue #24)。 |
...
```yaml
generated:
  by: "producer/aeps-llm-wiki-plugin/0.6.8"
...
**基准时间**(`v0.6.8` 起,PR-A 引入):**`generated.at`** 为唯一权威基准。
